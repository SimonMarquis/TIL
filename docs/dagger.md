...
typealias List<T> = kotlin.collections.List<@JvmSuppressWildcards T>
typealias Set<T> = kotlin.collections.Set<@JvmSuppressWildcards T>
typealias Map<K, V> = kotlin.collections.Map<K, @JvmSuppressWildcards V>
```
